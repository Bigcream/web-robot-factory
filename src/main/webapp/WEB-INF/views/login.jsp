...
<body>
    <div id="logreg-forms">
        ...
        <form class="form-signin" action="j_spring_security_check" id="formLogin" method="post">
            ...
            <input type="username" id="username" name="j_username" class="form-control" placeholder="Email address" required="" autofocus="">
            ...
            <form:form action="Register" method="post" class="form-signup" commandName="user">
                <div class="social-login">
